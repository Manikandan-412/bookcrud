...
const BookCrudComponent = () => {
    ...
    const fetchBooks = async () => {
        try {
            const response = await axios.get("https://book-backend-nkak.onrender.com/book/view");
    ...
    const handleSubmit = async (e) => {
        ...
        try {
            if (editingBook) {
                await axios.put(`https://book-backend-nkak.onrender.com/book/update/${editingBook._id}`, formData);
                setEditingBook(null);
            } else {
                await axios.post("https://book-backend-nkak.onrender.com/book/upload", formData);
            }
    ...
    const handleDelete = async (id) => {
        try {
            ...
            if (isDelete === true) {
                await axios.delete(`https://book-backend-nkak.onrender.com/book/delete/${id}`);
                fetchBooks();
            }
